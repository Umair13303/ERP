...
GO
/****** Object:  FullTextCatalog [db46757]    Script Date: 8/5/2026 10:52:54 AM ******/
CREATE FULLTEXT CATALOG [db46757] AS DEFAULT
GO
/****** Object:  UserDefinedTableType [dbo].[AFBillProduct_TVP]    Script Date: 8/5/2026 10:52:54 AM ******/
CREATE TYPE [dbo].[AFBillProduct_TVP] AS TABLE(
	[Id] [int] NULL,
	[GuID] [uniqueidentifier] NULL,
	[BillId] [int] NULL,
	[ProductId] [int] NULL,
	[ProductATIId] [int] NULL,
...
GO
/****** Object:  UserDefinedTableType [dbo].[AFCustomerLedger_TVP]    Script Date: 8/5/2026 10:52:54 AM ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[AFInventoryLedger_TVP]    Script Date: 8/5/2026 10:52:54 AM ******/
CREATE TYPE [dbo].[AFInventoryLedger_TVP] AS TABLE(
	...
	[UnitPurchasePrice] [decimal](18, 4) NULL,
...
GO
/****** Object:  UserDefinedTableType [dbo].[AFInvoiceProduct_TVP]    Script Date: 8/5/2026 10:52:54 AM ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[AFJournalVoucher_TVP]    Script Date: 8/5/2026 10:52:54 AM ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[AFSupplierLedger_TVP]    Script Date: 8/5/2026 10:52:54 AM ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[IAdjustmentPPQD_TVP]    Script Date: 8/5/2026 10:52:54 AM ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[IProductStockSummary_Variant_TVP]    Script Date: 8/5/2026 10:52:54 AM ******/
...
GO
/****** Object:  UserDefinedTableType [dbo].[PPurchasePPQD_TVP]    Script Date: 8/5/2026 10:52:54 AM ******/
CREATE TYPE [dbo].[PPurchasePPQD_TVP] AS TABLE(
	[GuID] [uniqueidentifier] NULL,
	[ProductId] [int] NULL,
	[ProductCombinationId] [int] NULL,
...
GO
/****** Object:  UserDefinedTableType [dbo].[ProductCombination_TVP]    Script Date: 8/5/2026 10:52:54 AM ******/
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_CalculateLineTotalByATI]    Script Date: 8/5/2026 10:52:54 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE FUNCTION [dbo].[fn_CalculateLineTotalByATI]
(
...
AS
BEGIN
    -- Opening-balance / non-product lines carry no ATI (ProductATIId is NULL by design —
    -- see SaleOperationUpsertService / ProcurementUpsertService OB construction).
    -- No tax configuration applies to these; return the raw net amount directly,
    -- with no dependency on retProductConfigByATI returning/not-returning rows.
    IF @ProductATIId IS NULL OR @ProductATIId = 0
    ...
    SELECT @Total = 
        ...
        END
    FROM [dbo].[retProductConfigByATI](@ProductATIId) AS PC;

    RETURN ISNULL(@Total, (@ActualAmount - @DiscountAmount));
END
GO
/****** Object:  UserDefinedFunction [dbo].[fn_CalculateLineTotalByPriceLog]    Script Date: 8/5/2026 10:52:54 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE FUNCTION [dbo].[fn_CalculateLineTotalByPriceLog]
(
    @ActualAmount DECIMAL(18,2),
    @DiscountAmount DECIMAL(18,2),
...
BEGIN
    ...
    SELECT @Total = 
        CASE 
            ...
            ELSE (@ActualAmount - @DiscountAmount) 
        END
    FROM [dbo].[retProductConfigByPriceLog](@ProductPriceLogId) AS PC;
    RETURN ISNULL(@Total, (@ActualAmount - @DiscountAmount));
END
GO
/****** Object:  UserDefinedFunction [dbo].[fn_CodeFormat]    Script Date: 8/5/2026 10:52:54 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_CodeSplitByCommaAsINT]    Script Date: 8/5/2026 10:52:54 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  UserDefinedFunction [dbo].[fn_InvoiceStatus]    Script Date: 8/5/2026 10:52:54 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  Table [dbo].[AFInvoicePPI]    Script Date: 8/5/2026 10:52:54 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[IProduct]    Script Date: 8/5/2026 10:52:54 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[IProductATI]    Script Date: 8/5/2026 10:52:54 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[vHSCode]    Script Date: 8/5/2026 10:52:54 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[vItemType]    Script Date: 8/5/2026 10:52:54 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[vSaleTaxType]    Script Date: 8/5/2026 10:52:54 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[retProductConfigByATI]    Script Date: 8/5/2026 10:52:54 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE FUNCTION [dbo].[retProductConfigByATI]
(
    @ProductATIId INT
)
RETURNS TABLE
...
(
    SELECT 
        ...
        STT.DefaultRate,
        STT.AdditionalRate
    FROM IProductATI AS ATI WITH(NOLOCK)
    INNER JOIN IProduct     AS P   WITH(NOLOCK) ON P.Id = ATI.ProductId
    ...
    WHERE ATI.Id = @ProductATIId
);
GO
/****** Object:  UserDefinedFunction [dbo].[fn_GetInvoiceCalculations]    Script Date: 8/5/2026 10:52:54 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
(
    SELECT 
        ...
        CAST(SUM(
            CASE WHEN ISNULL(PC.IsSaleTaxExclusive,0) = 1 
    ...
    OUTER APPLY [dbo].[retProductConfigByATI](P.ProductATIId) AS PC   -- CHANGED
    WHERE P.InvoiceId = @InvoiceId
    GROUP BY P.InvoiceId, P.Id
);
GO
/****** Object:  Table [dbo].[AFProductPriceLog]    Script Date: 8/5/2026 10:52:54 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[AFProductPriceLog](
	...
	[BranchId] [int] NULL,
	[CompanyId] [int] NULL,
 CONSTRAINT [PK__AFProduc__3214EC07ACC0F658] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
/****** Object:  UserDefinedFunction [dbo].[retProductConfigByPriceLog]    Script Date: 8/5/2026 10:52:54 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE FUNCTION [dbo].[retProductConfigByPriceLog]
(
    @ProductPriceLogId INT
)
RETURNS TABLE 
...
(
    SELECT 
        ...
        STT.DefaultRate,
        STT.AdditionalRate
    FROM AFProductPriceLog AS PPL WITH(NOLOCK)
    INNER JOIN IProductATI  AS ATI WITH(NOLOCK) ON ATI.Id = PPL.ProductATIId
    INNER JOIN IProduct     AS P   WITH(NOLOCK) ON P.Id   = PPL.ProductId
    INNER JOIN vItemType    AS IT  WITH(NOLOCK) ON ATI.ItemTypeId = IT.Id
    INNER JOIN vHSCode      AS HS  WITH(NOLOCK) ON ATI.HSCodeId = HS.Id
    INNER JOIN vSaleTaxType AS STT WITH(NOLOCK) ON ATI.SaleTaxTypeId = STT.Id
    WHERE PPL.Id = @ProductPriceLogId
);
GO
/****** Object:  Table [dbo].[ACBranch]    Script Date: 8/5/2026 10:52:54 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ACCompany]    Script Date: 8/5/2026 10:52:54 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ACSaleUnit]    Script Date: 8/5/2026 10:52:54 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ACUser]    Script Date: 8/5/2026 10:52:54 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AFBill]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AFBillPPI]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AFBillReceipt]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[AFBillReceipt](
	[Id] [int] IDENTITY(1,1) NOT NULL,
	[GuID] [uniqueidentifier] NULL,
	[Code] [nvarchar](max) NULL,
	[LocationId] [int] NULL,
...
GO
/****** Object:  Table [dbo].[AFChartOfAccount]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AFCustomerLedger]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AFGeneralLedger]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[AFGeneralLedger](
	...
	[RefDocumentType] [int] NULL,
	[RefDocumentId] [int] NULL,
	[DocumentCode] [nvarchar](max) NULL,
	[Description] [nvarchar](max) NULL,
	...
	[BranchId] [int] NULL,
	[CompanyId] [int] NULL,
 CONSTRAINT [PK_AFGeneralLedger] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
/****** Object:  Table [dbo].[AFInventoryLedger]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AFInvoice]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AFInvoiceReceipt]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AFJournalVoucher]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AFStockLedger]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[AFStockLedger](
	[Id] [bigint] IDENTITY(1,1) NOT NULL,
	[TransactionDate] [datetime] NOT NULL,
	[LocationId] [int] NOT NULL,
	[ProductId] [int] NOT NULL,
	...
	[RefDocumentType] [int] NOT NULL,
	[RefDocumentId] [int] NOT NULL,
	[DocumentCode] [nvarchar](100) NULL,
	[CreatedOn] [datetime] NOT NULL,
	[CreatedBy] [int] NOT NULL,
 CONSTRAINT [PK_AFStockLedger] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [dbo].[AFSupplierLedger]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AppForm]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AppUser]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Branch]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Company]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[confApplicationRule]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[confApplicationRule](
	[Id] [int] NOT NULL,
	[ClientKEY] [int] NULL,
	[WalkInCustomerLimit] [int] NULL,
	[DefaultSaleMargin] [decimal](18, 2) NOT NULL,
	[IsWhatsAppInvoicing] [bit] NOT NULL,
PRIMARY KEY CLUSTERED 
(
	[Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
...
GO
/****** Object:  Table [dbo].[confclientproductsetting]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[confClientSetting]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[confScheduledMessage]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[confScheduledMessage](
	[Id] [int] IDENTITY(1,1) NOT NULL,
	[RefDocumentType] [int] NULL,
	[RefDocumentGuID] [uniqueidentifier] NULL,
...
GO
/****** Object:  Table [dbo].[CSDefaultChartOfAccount]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[CSDefaultChartOfAccount](
	[Id] [int] IDENTITY(1,1) NOT NULL,
	[GuID] [uniqueidentifier] NULL,
	[Code] [nvarchar](max) NULL,
	[AccountCategoryId] [int] NULL,
	[DefaultChartOfAccountId] [int] NULL,
	[CreatedOn] [datetime] NULL,
	[CreatedBy] [int] NULL,
	[UpdatedOn] [datetime] NULL,
	[UpdatedBy] [int] NULL,
...
GO
/****** Object:  Table [dbo].[CSDepartment]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[IAdjustment]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[IAdjustmentPPQD]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[IBrand]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ICategory]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[IProductCCE]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[IProductCCE](
	[Id] [int] IDENTITY(1,1) NOT NULL,
	[GuID] [uniqueidentifier] NULL,
	[RefDocumentType] [int] NULL,
	[ProductId] [int] NULL,
...
GO
/****** Object:  Table [dbo].[ISection]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ISubCategory]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[osvChartOfAccount]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[osvProductCombination]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[osvProductCombination](
	...
	[Attribute] [nvarchar](max) NULL,
	[Status] [bit] NULL,
	[AttributeKey]  AS (CONVERT([nvarchar](450),isnull([Attribute],'##NULL_SENTINEL##'))) PERSISTED,
PRIMARY KEY CLUSTERED 
(
	[Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
...
GO
/****** Object:  Table [dbo].[PSupplier]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SOCustomer]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[UserRight]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[vAccountCatagory]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[vAccountType]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[vAttribute]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[vCity]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[vCostingMode]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[vCountry]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[vFinancialStatement]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[vInventoryAdjustmentType]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[vOrganisationType]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[vPaymentMethod]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[vProductType]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[vRight]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[vRole]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[vTierType]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[vUnit]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[AFBillPPI] ADD  CONSTRAINT [DF_AFBillPPI_Quantity]  DEFAULT ((0)) FOR [Quantity]
GO
ALTER TABLE [dbo].[AFBillPPI] ADD  CONSTRAINT [DF_AFBillPPI_UnitPurchasePrice]  DEFAULT ((0)) FOR [UnitPurchasePrice]
GO
...
GO
ALTER TABLE [dbo].[AFBillReceipt] ADD  DEFAULT ((0)) FOR [ReceiptAmount]
GO
ALTER TABLE [dbo].[AFGeneralLedger] ADD  DEFAULT (getdate()) FOR [TransactionDate]
GO
ALTER TABLE [dbo].[AFGeneralLedger] ADD  DEFAULT ((0.0000)) FOR [Debit]
GO
ALTER TABLE [dbo].[AFGeneralLedger] ADD  DEFAULT ((0.0000)) FOR [Credit]
GO
ALTER TABLE [dbo].[AFGeneralLedger] ADD  DEFAULT (getdate()) FOR [CreatedOn]
GO
...
GO
ALTER TABLE [dbo].[AFInventoryLedger] ADD  CONSTRAINT [DF_AFInventoryLedger_UnitPurchasePrice]  DEFAULT ((0)) FOR [UnitPurchasePrice]
GO
ALTER TABLE [dbo].[AFInventoryLedger] ADD  CONSTRAINT [DF_AFInventoryLedger_UnitSalePrice]  DEFAULT ((0)) FOR [UnitSalePrice]
GO
...
GO
ALTER TABLE [dbo].[AFInvoicePPI] ADD  CONSTRAINT [DF_AFInvoicePPI_UnitPurchasePrice]  DEFAULT ((0)) FOR [UnitSalePrice]
GO
...
GO
ALTER TABLE [dbo].[AFProductPriceLog] ADD  CONSTRAINT [DF__AFProduct__Defau__1F83A428]  DEFAULT ((0)) FOR [DefaultSalePrice]
GO
ALTER TABLE [dbo].[AFProductPriceLog] ADD  CONSTRAINT [DF__AFProduct__Minim__2077C861]  DEFAULT ((0)) FOR [MinimumSalePrice]
GO
ALTER TABLE [dbo].[AFStockLedger] ADD  DEFAULT (getdate()) FOR [TransactionDate]
GO
ALTER TABLE [dbo].[AFStockLedger] ADD  DEFAULT ((0.0000)) FOR [QtyIn]
GO
ALTER TABLE [dbo].[AFStockLedger] ADD  DEFAULT ((0.0000)) FOR [QtyOut]
GO
ALTER TABLE [dbo].[AFStockLedger] ADD  DEFAULT ((0.0000)) FOR [UnitCost]
GO
ALTER TABLE [dbo].[AFStockLedger] ADD  DEFAULT ((0.0000)) FOR [UnitPrice]
GO
ALTER TABLE [dbo].[AFStockLedger] ADD  DEFAULT (getdate()) FOR [CreatedOn]
GO
...
GO
ALTER TABLE [dbo].[confApplicationRule] ADD  DEFAULT ((0)) FOR [DefaultSaleMargin]
GO
ALTER TABLE [dbo].[confApplicationRule] ADD  DEFAULT ((0)) FOR [IsWhatsAppInvoicing]
GO
...
GO
/****** Object:  StoredProcedure [dbo].[ACBranch_Upsert]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ACCompany_Upsert]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[ACUser_Upsert]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[AFBill_GLBParam]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE   PROCEDURE [dbo].[AFBill_GLBParam]    
    @GuID               UNIQUEIDENTIFIER,    
    @SupplierIds        NVARCHAR(MAX),    
    @DocumentStatusIds  NVARCHAR(MAX),    
    @BillStatusIds      NVARCHAR(MAX),    
...
SELECT     
    ...
    'BILL-' + B.[Code]          AS [Code],    
    B.[TransactionDate],    
    SUM(BPPI.ActualAmount)      AS [GrossAmount],  
    SUM(BPPI.DiscountAmount)    AS [DiscountAmount],  
    SUM(BPPI.ChargedAmount)     AS [NetAmount],  
    B.[DueAmount],    
    B.[BillTypeId],    
    B.[DocumentStatus],    
    B.[BillStatus],    
...
FROM        [dbo].[AFBill]      AS B    WITH(NOLOCK)    
INNER JOIN  [dbo].[PSupplier]   AS S    WITH(NOLOCK) ON S.Id = B.SupplierId AND S.Status =1 AND S.DocumentStatus IN (SELECT [sID] FROM dbo.fn_CodeSplitByCommaAsINT(@DocumentStatusIds))
INNER JOIN  [dbo].[AFBillPPI]   AS BPPI WITH(NOLOCK) ON B.Id = BPPI.BillId  AND BPPI.Status =1 AND BPPI.DocumentStatus IN (SELECT [sID] FROM dbo.fn_CodeSplitByCommaAsINT(@DocumentStatusIds))
  
WHERE    

B.Status=1    
AND (@TransactionDate IS NULL OR CAST(B.[TransactionDate] AS DATE) = CAST(@TransactionDate AS DATE))
AND (@GuID              IS NULL     OR B.[GuID] = @GuID)    
AND (@SupplierIds       IS NULL     OR B.[SupplierId]IN (SELECT [sID] FROM dbo.fn_CodeSplitByCommaAsINT(@SupplierIds))) 
AND B.[DocumentStatus]              IN (SELECT [sID] FROM dbo.fn_CodeSplitByCommaAsINT(@DocumentStatusIds))  
AND ((@BillStatusIds    IS NULL     OR @BillStatusIds ='' )   OR B.[BillStatus]IN (SELECT [sID] FROM dbo.fn_CodeSplitByCommaAsINT(@BillStatusIds))) 
...
GO
/****** Object:  StoredProcedure [dbo].[AFBill_Upsert]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
 ...
 BEGIN              
  ...
  DECLARE @Code  NVARCHAR(MAX)              
   ...
   WHERE YEAR(CreatedOn) = YEAR(GETDATE())              
     AND MONTH(CreatedOn) = MONTH(GETDATE())              
     AND CompanyId = @CompanyId;              
     --SELECT @DueAmount = SUM(dbo.fn_CalculateLineTotal(ActualAmount, DiscountAmount, ProductId, @DocumentStatus)) -- OLD NEED TO BE REMOVED
     SELECT @DueAmount = SUM(dbo.fn_CalculateLineTotalByATI(ActualAmount, DiscountAmount, ProductATIId))
    FROM @AFBill_TVP;
  ...
  SELECT               
   ...
   BTVP.[ProductId],             
   BTVP.[ProductATIId],  
   BTVP.[ProductCombinationId],            
   BTVP.[Quantity],        
   BTVP.[UnitPurchasePrice],    
   BTVP.[ActualAmount],              
   BTVP.[DiscountAmount],              
   BTVP.[ChargedAmount],            
   BTVP.[Batch],            
...
END CATCH
GO
/****** Object:  StoredProcedure [dbo].[AFBillReceipt_Upsert]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
      
CREATE PROCEDURE [dbo].[AFBillReceipt_Upsert]      
    @DB_OperationType   NVARCHAR(MAX),      
    @GuID               UNIQUEIDENTIFIER,      
    @LocationId         INT,      
    @TransactionDate    DATETIME,      
...
END 
GO
/****** Object:  StoredProcedure [dbo].[AFChartOfAccount_Upsert]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[AFCustomerLedger_Upsert]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END CATCH
GO
/****** Object:  StoredProcedure [dbo].[AFInventoryLedger_Upsert]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
    ...
    BEGIN TRY          
        ...
        BEGIN          
            ...
            SELECT          
                ...
                ILTVP.[ProductId],          
                ILTVP.[ProductCombinationId],            
                @RefDocumentType,          
                ILTVP.[RefDocumentId],          
                ILTVP.[Description],          
                ILTVP.[QuantityIn],          
                ILTVP.[QuantityOut],    
                ILTVP.[UnitPurchasePrice],    
                ILTVP.[UnitSalePrice],       
                ILTVP.[Debit],          
                ILTVP.[Credit],        
                ILTVP.[Batch],        
...
END; 
GO
/****** Object:  StoredProcedure [dbo].[AFInvoice_GLBParam]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN  
    SELECT      
        ...
        'INV-' + I.[Code]               AS [Code],    
        I.[TransactionDate],    
        SUM(CALC.[GrossAmount])         AS [GrossAmount],    
        SUM(CALC.[DiscountAmount])      AS [DiscountAmount],    
        SUM(CALC.[TaxableAmount])       AS [TaxableAmount],    
        SUM(CALC.[SaleTaxAmount])       AS [SaleTaxAmount],    
        SUM(CALC.[AdditionalTaxAmount]) AS [AdditionalTaxAmount],    
        SUM(CALC.[NetAmount])           AS [NetAmount],    
        I.[DueAmount],    
        I.[InvoiceTypeId],    
        I.[DocumentStatus],    
        I.[InvoiceStatus],    
    ...
    WHERE I.Status = 1    
      ...
      AND I.DocumentStatus IN (SELECT value FROM STRING_SPLIT(@DocumentStatus, ','))  
    GROUP BY   
        C.[Description],   
        I.[Code],   
        I.[TransactionDate],   
...
END
GO
/****** Object:  StoredProcedure [dbo].[AFInvoice_RptDetail_GBLParam]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[AFInvoice_RptDetail_GBLParam]    
    @GuID           UNIQUEIDENTIFIER,    
    @DocumentStatus NVARCHAR(MAX)
AS
SELECT
P.Description AS ProductName,
IPPI.Quantity,
IPPI.UnitSalePrice  AS DefaultUnitPrice,
IPPI.ActualAmount,
IPPI.DiscountAmount,
IPPI.ChargedAmount

FROM AFInvoicePPI AS IPPI
INNER JOIN AFInvoice AS I ON IPPI.InvoiceId = I.Id AND I.GuID = @GuID
LEFT JOIN IProduct AS P ON IPPI.ProductId = P.Id

WHERE IPPI.Status  = 1

AND IPPI.DocumentStatus IN (SELECT value FROM STRING_SPLIT(@DocumentStatus, ','))  
GO
/****** Object:  StoredProcedure [dbo].[AFInvoice_RptHeader_GBLParam]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[AFInvoice_RptHeader_GBLParam]
 @LocationId INT,
...
FROM AFInvoice  AS I
INNER JOIN ACBranch AS B ON I.LocationId = B.Id   
INNER JOIN SOCustomer AS C ON I.CustomerId = C.Id
INNER JOIN ACUser AS U ON I.CreatedBy = U.Id

CROSS APPLY [dbo].[fn_GetInvoiceCalculations](I.Id, 1) AS CALC   

WHERE I.LocationId = @LocationId AND I.[GuID] = @InvoiceGUID
...
GROUP BY
	...
	U.[Description]
GO
/****** Object:  StoredProcedure [dbo].[AFInvoice_Upsert]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END CATCH 
GO
/****** Object:  StoredProcedure [dbo].[AFInvoiceReceipt_Upsert]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END 
GO
/****** Object:  StoredProcedure [dbo].[AFJournal_Upsert]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[AFJournalVoucher_Upsert]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END CATCH
GO
/****** Object:  StoredProcedure [dbo].[AFSupplierLedger_Upsert]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END CATCH  
GO
/****** Object:  StoredProcedure [dbo].[CSDepartment_Upsert]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[IAdjustment_Upsert]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN TRY      
  ...
  SELECT      
            ...
            @AdjustmentId,       
            t.[ProductId],       
            T.[ProductCombinationId],     -- mapped from merge result    
            T.[UnitPurchasePrice],      
            T.[UnitSalePrice],      
            T.[QuantityIn],      
            T.[QuantityOut],      
...
END CATCH
GO
/****** Object:  StoredProcedure [dbo].[IBrand_Upsert]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ICategory_Upsert]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[IProduct_Upsert]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END 
GO
/****** Object:  StoredProcedure [dbo].[IProductATI_Upsert]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ISection_Upsert]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ISubCategory_Upsert]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[PPurchase_Upsert]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE PROCEDURE [dbo].[PPurchase_Upsert]          
    @DB_OperationType      NVARCHAR(MAX),          
    @GuID                  UNIQUEIDENTIFIER,          
    @BillId                INT,                      -- Provided direct bill linkage param
    @LocationId            INT, 
    @TransactionDate       DATETIME,          
    @SupplierId            INT,          
    @Description           NVARCHAR(MAX),          
    ...
    @BranchId              INT,          
    @CompanyId             INT,          
    @PPurchase_TVP         [dbo].[PPurchasePPQD_TVP] READONLY,          
    @DocumentCode          NVARCHAR(MAX) OUTPUT,          
    @InsertedId            INT OUTPUT,          
    @Response              INT OUTPUT        
AS          
BEGIN TRY          
    ...
    BEGIN           
        ...
        -- 1. Process Variations via Product Combination Engine
        ...
        -- 2. Generate Formatted Document Sequence Code
        SELECT @Code = dbo.fn_CodeFormat(          
            MAX(CAST(SUBSTRING(Code,8,LEN(Code)) AS BIGINT))          
        )          
        FROM [PPurchase]          
        ...
        -- 4. Insert Grid Details (Fixed: Restored the missing explicit INSERT clause)
        INSERT INTO [dbo].[PPurchasePPQD]
        (
            [GuID], 
            [PurchaseId], 
            [ProductId],          
        ...
        SELECT            
            ISNULL(P_TVP.[GuID], NEWID()), 
            @PurchaseId, 
            P_TVP.[ProductId],          
            MC.[ProductCombinationId], 
            P_TVP.[Quantity], 
            P_TVP.[UnitPurchasePrice],          
            P_TVP.[UnitSalePrice], 
            P_TVP.[Batch], 
            P_TVP.[ExpiryDate], 
            @CreatedOn,          
            @CreatedBy, 
            P_TVP.[DocumentType], 
            P_TVP.[DocumentStatus], 
            P_TVP.[Status]          
        FROM @PPurchase_TVP P_TVP          
        LEFT JOIN @MappedCombinations mc              
               ON mc.ProductId = P_TVP.ProductId              
              AND ((mc.Attribute IS NULL AND P_TVP.Attribute IS NULL)    
               OR mc.Attribute = P_TVP.Attribute);    

        SET @DocumentCode = @Code;          
        SET @InsertedId   = @PurchaseId;          
        SET @Response     = 201;          
    END          
...
END CATCH
GO
/****** Object:  StoredProcedure [dbo].[ProductCombination_Merge]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN  
    ...
    -- Fix 1: NULL-safe MERGE statement using standard NULL-safe evaluation
    ...
    ON (
        ...
        AND (
            (Target.Attribute IS NULL AND Source.Attribute IS NULL)
            OR Target.Attribute = Source.Attribute
        )
    )
    WHEN MATCHED THEN
    ...
    INTO @OutputTable (CombinationId, ProductId, Attribute);

    -- Fix 2: Fallback SELECT to capture pre-existing matching records
    ...
    INNER JOIN (SELECT DISTINCT ProductId, Attribute FROM @Combinations) c
        ON pc.ProductId = c.ProductId
        AND (
            (pc.Attribute IS NULL AND c.Attribute IS NULL)
            OR pc.Attribute = c.Attribute
        )
    WHERE NOT EXISTS (
        SELECT 1 FROM @OutputTable o
        WHERE o.ProductId = pc.ProductId
          AND (
              (o.Attribute IS NULL AND pc.Attribute IS NULL) 
              OR o.Attribute = pc.Attribute
          )
    );

    -- Return the final output table data to the calling application
    SELECT CombinationId, ProductId, Attribute 
    FROM @OutputTable;

END;
GO
/****** Object:  StoredProcedure [dbo].[PSupplier_Upsert]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END  
GO
/****** Object:  StoredProcedure [dbo].[RptCustomerSummary_GLBParam]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
--EXEC [RptCustomerSummary_GLBParam]     1, 1, '3,2,1', '1,2,3,4,5','1',''        
    
    @BranchId           INT,                
    @CompanyId          INT,                
...
AS                
              
    WITH InvoiceRecieptCTE AS (                
        SELECT                 
            CustomerId,        
            SUM(ISNULL((ReceiptAmount),0))     AS [TotalReciept]         
                
        FROM [dbo].[AFInvoiceReceipt] AS PR WITH(NOLOCK)                
        WHERE       

            PR.[Status] = 1    AND PR.CustomerId  IN (SELECT [sID] FROM dbo.fn_CodeSplitByCommaAsINT(@CustomerIds))          
        AND ((@CustomerIds IS NULL OR @CustomerIds = '')  OR PR.[CustomerId] IN (SELECT [sID] FROM dbo.fn_CodeSplitByCommaAsINT(@CustomerIds)))        
...
                SUM(DueAmount) AS TotalDue,      
                ISNULL(SUM(dbo.fn_CalculateLineTotalByATI(PPI.ActualAmount, PPI.DiscountAmount, PPI.ProductATIId)), 0) AS [TotalRecievable]                
            FROM [dbo].[AFInvoice]          AS I    WITH(NOLOCK)                
            INNER JOIN [dbo].[AFInvoicePPI] AS PPI  WITH(NOLOCK) ON PPI.InvoiceId =I.Id AND PPI.Status=1                
            WHERE                 
                
                I.[Status] = 1    
            AND ((@CustomerIds IS NULL OR @CustomerIds = '')  OR I.[CustomerId] IN (SELECT [sID] FROM dbo.fn_CodeSplitByCommaAsINT(@CustomerIds)))        
...
        ISNULL(IC.[TotalRecievable], 0) - ISNULL(PRC.[TotalReciept], 0)  AS [Due]        
        
    FROM [dbo].[SOCustomer]     AS C    WITH(NOLOCK)                
    LEFT JOIN InvoiceCTE        AS IC   WITH(NOLOCK) ON C.Id = IC.CustomerId                
    LEFT JOIN InvoiceRecieptCTE AS PRC  WITH(NOLOCK) ON C.Id = PRC.CustomerId                
    WHERE C.[Status]=1                
    AND C.CompanyId =@CompanyId                
    AND C.BranchId =@BranchId         
    AND ((@CustomerIds IS NULL OR @CustomerIds = '')  OR C.[Id] IN (SELECT [sID] FROM dbo.fn_CodeSplitByCommaAsINT(@CustomerIds)))        
GO
/****** Object:  StoredProcedure [dbo].[RptInventoryAdjustment_GLBParam]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[RptInvoiceReceipt_GLBParam]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[RptSaleLedger_GLBParam]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AND CL.[ReconcillationStatus] IN (SELECT [sID] FROM dbo.fn_CodeSplitByCommaAsINT(@ReconcillationStatusIds))   
...
GO
/****** Object:  StoredProcedure [dbo].[RptSupplierSummary_GLBParam]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[RptSupplierSummary_GLBParam]        
 @BranchId           INT,     
 @CompanyId          INT,  
 @PaymentStatusIds   NVARCHAR(MAX),        
 @BillStatusIds      NVARCHAR(MAX),        
 @DocumentStatusIds  NVARCHAR(MAX)      
 AS       
    WITH BillRecieptCTE AS (        
        SELECT         
            SupplierId,         
            SUM(ReceiptAmount) AS TotalReciept        
        
        FROM [dbo].[AFBillReceipt] AS PR WITH(NOLOCK)        
        WHERE         
            PR.[Status] = 1         
        AND PR.[DocumentStatus] IN (SELECT [sID] FROM dbo.fn_CodeSplitByCommaAsINT(@DocumentStatusIds))          
        AND PR.[PaymentStatus] IN (SELECT [sID] FROM dbo.fn_CodeSplitByCommaAsINT(@PaymentStatusIds))          
    ...
    BillCTE AS (        
        SELECT         
                SupplierId,         
                SUM(DueAmount) AS TotalDue,        
                (SUM(PPI.ActualAmount) - SUM(PPI.DiscountAmount))   AS TotalRecievable        
        
            FROM [dbo].[AFBill]             AS B    WITH(NOLOCK)        
            INNER JOIN [dbo].[AFBillPPI] AS PPI  WITH(NOLOCK) ON PPI.BillId =B.Id AND PPI.Status=1        
            WHERE         
        
                B.[Status] = 1         
            AND B.[DocumentStatus] IN (SELECT [sID] FROM dbo.fn_CodeSplitByCommaAsINT(@DocumentStatusIds))          
            AND B.[BillStatus] IN (SELECT [sID] FROM dbo.fn_CodeSplitByCommaAsINT(@BillStatusIds))          
            GROUP BY SupplierId        
    )        
    SELECT         
        P.[Id] AS [CustomerId],        
    ...
    FROM [dbo].[PSupplier]   AS P    WITH(NOLOCK)        
    LEFT JOIN BillCTE        AS IC   WITH(NOLOCK) ON P.Id = IC.SupplierId        
    LEFT JOIN BillRecieptCTE AS PRC  WITH(NOLOCK) ON P.Id = PRC.SupplierId        
    WHERE   P.[Status]=1        
    AND     P.CompanyId =@CompanyId        
    AND     P.BranchId =@BranchId 
GO
/****** Object:  StoredProcedure [dbo].[SOCustomer_Upsert]    Script Date: 8/5/2026 10:52:55 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
--ALTER TABLE SOCustomer ADD IsWalkInCustomer BIT
